...
const results = {
  hairline: [
    ...
    },
    {
      ...
      beforeImage: "/images/results/hairline-2-before.jpg",
      afterImage: "/images/results/hairline-2-after.jpg",
      technique: "DHI" as const,
      grafts: 1800,
      timeframe: "10 months",
    },
    {
      ...
      beforeImage: "/images/results/hairline-3-before.jpg",
      afterImage: "/images/results/hairline-3-after.jpg",
  ...
  diffuse: [
    {
      ...
      beforeImage: "/images/results/diffuse-1-before.jpg",
      afterImage: "/images/results/diffuse-1-after.jpg",
      technique: "FUE" as const,
      grafts: 3200,
      timeframe: "14 months",
    },
    {
      ...
      beforeImage: "/images/results/diffuse-2-before.jpg",
      afterImage: "/images/results/diffuse-2-after.jpg",
      technique: "FUE" as const,
      grafts: 2800,
      timeframe: "12 months",
    },
  ...
  advanced: [
    {
      ...
      beforeImage: "/images/results/advanced-1-before.jpg",
      afterImage: "/images/results/advanced-1-after.jpg",
      technique: "DHI" as const,
      grafts: 3000,
      timeframe: "14 months",
    },
    {
      ...
      beforeImage: "/images/results/advanced-2-before.jpg",
      afterImage: "/images/results/advanced-2-after.jpg",
      technique: "FUE" as const,
      grafts: 3500,
      timeframe: "12 months",
    },
  ...
  crown: [
    {
      ...
      beforeImage: "/images/results/crown-1-before.jpg",
      afterImage: "/images/results/crown-1-after.jpg",
      technique: "FUE" as const,
      grafts: 2400,
      timeframe: "12 months",
    },
    {
      ...
      beforeImage: "/images/results/crown-2-before.jpg",
      afterImage: "/images/results/crown-2-after.jpg",
      technique: "FUE" as const,
      grafts: 2000,
      timeframe: "10 months",
    },
